...
def make_map():
    ...
    map.connect('log/i/', controller='log', action='infomarker', infomarker_id=0)
    map.connect('log/i/:infomarker_id', controller='log', action='infomarker', infomarker_id=0)
    map.connect('log/infomarker/', controller='log', action='infomarker', infomarker_id=0)
    map.connect('log/infomarker/:infomarker_id', controller='log', action='infomarker', infomarker_id=0)
    ...
    map.connect('log/c/', controller='log', action='c', country_id=0, page=None)
    map.connect('log/c/:country_id/:page', controller='log', action='c', country_id=0, page=None)
    ...
    map.connect('view/c/', controller='view', action='c', country_id=0,page=None)
    map.connect('view/c/:country_id/:page', controller='view', action='c', country_id=0, page=None)
