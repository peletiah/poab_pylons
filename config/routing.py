...
def make_map():
    ...
    map.connect('log/s/', controller='log', action='solo', log_id=0)
    map.connect('log/s/:log_id', controller='log', action='solo', log_id=0)
    map.connect('log/solo/', controller='log', action='solo', log_id=0)
    map.connect('log/solo/:log_id', controller='log', action='solo', log_id=0)
